...
def test_v3816_release_notes_are_linked():
    ...
    assert 'HFC_VERSION: "${HFC_VERSION:-v3.8.16}"' in compose


def test_todo_points_to_v38_public_plan_docs():
    todo = read_doc("TODO.md")

    assert "## V3.8 系列路线：V3.8.0 / V3.8.1 / V3.8.2 / V3.8.3 / V3.8.4 / V3.8.5 / V3.8.6 / V3.8.7 / V3.8.8 / V3.8.9 / V3.8.10 / V3.8.11 / V3.8.12 / V3.8.13 / V3.8.14 / V3.8.15 / V3.8.16" in todo
